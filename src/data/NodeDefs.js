...
export const NodeDefs = {
  ...
  Dot: { 
    label: 'Dot Product', cat: 'Vector', inputs: 2, 
    pinsIn: ['A', 'B'], pinsOut: [{ label: 'dot', type: 'f32' }], 
    params: [] 
  },
  Cross: { 
    label: 'Cross Product', cat: 'Vector', inputs: 2, 
    pinsIn: ['A', 'B'], pinsOut: [{ label: 'cross', type: 'vec3' }], 
    params: [] 
  },
  Normalize: { 
    label: 'Normalize', cat: 'Vector', inputs: 1, 
    pinsIn: ['Vec'], pinsOut: [{ label: 'norm', type: 'vec3' }], 
    params: [] 
  },
  Length: { 
    label: 'Length', cat: 'Vector', inputs: 1, 
    pinsIn: ['Vec'], pinsOut: [{ label: 'len', type: 'f32' }], 
    params: [] 
  },
  Distance: { 
    label: 'Distance', cat: 'Vector', inputs: 2, 
    pinsIn: ['A', 'B'], pinsOut: [{ label: 'dist', type: 'f32' }], 
    params: [] 
  },
  Reflect: { 
    label: 'Reflect', cat: 'Vector', inputs: 2, 
    pinsIn: ['I', 'N'], pinsOut: [{ label: 'refl', type: 'vec3' }], 
    params: [] 
  },
  Refract: { 
    label: 'Refract', cat: 'Vector', inputs: 3, 
    pinsIn: ['I', 'N', 'eta'], pinsOut: [{ label: 'refr', type: 'vec3' }], 
    params: [] 
  },
  ...
  // Noise Nodes
  Random: {
    label: 'Random', cat: 'Noise', inputs: 1, outputs: 1,
    pinsIn: ['UV'], pinsOut: [{ label: 'out', type: 'vec3' }],
    params: [
  ...
  ValueNoise: {
    label: 'Value Noise', cat: 'Noise', inputs: 1, outputs: 1,
    pinsIn: ['UV'], pinsOut: [{ label: 'out', type: 'vec3' }],
    params: [
  ...
  FBMNoise: {
    label: 'FBM Noise', cat: 'Noise', inputs: 1, outputs: 1,
    pinsIn: ['UV'], pinsOut: [{ label: 'out', type: 'vec3' }],
    params: [
  ...
  SimplexNoise: {
    label: 'Simplex Noise', cat: 'Noise', inputs: 1, outputs: 1,
    pinsIn: ['UV'], pinsOut: [{ label: 'out', type: 'vec3' }],
    params: [
  ...
  VoronoiNoise: {
    label: 'Voronoi Noise', cat: 'Noise', inputs: 1, outputs: 1,
    pinsIn: ['UV'], pinsOut: [{ label: 'out', type: 'vec3' }],
    params: [
  ...
  RidgedNoise: {
    label: 'Ridged Noise', cat: 'Noise', inputs: 1, outputs: 1,
    pinsIn: ['UV'], pinsOut: [{ label: 'out', type: 'vec3' }],
    params: [
      { name: 'scale', label: 'Scale', type: 'float', default: 4.0 },
  ...
  WarpNoise: {
    label: 'Warp Noise', cat: 'Noise', inputs: 1, outputs: 1,
    pinsIn: ['UV'], pinsOut: [{ label: 'out', type: 'vec3' }],
    params: [
      { name: 'scale', label: 'Scale', type: 'float', default: 3.0 },
  ...
  Texture2D: { 
    ...
    params: [
      ...
      { name: 'wrapU', type: 'select', options: ['repeat', 'clamp', 'mirror'], default: 'repeat', label: 'Wrap U' },
      { name: 'wrapV', type: 'select', options: ['repeat', 'clamp', 'mirror'], default: 'repeat', label: 'Wrap V' },
      { name: 'filter', type: 'select', options: ['linear', 'nearest'], default: 'linear', label: 'Filter' }
    ]
  },
